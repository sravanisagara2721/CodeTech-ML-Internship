# CodeTech-ML-Internship
Machine Learning Internship tasks using Python , Scikit-learn, NLP, CNN, Tensorflow and Recommendation system
 CodTech Machine Learning Internship

 Intern Details
FieldDetailsNameSravaniCompanyCodTech IT SolutionsDomainMachine LearningDurationAs per internship offer letter
...
Techniques Used:
TechniqueMethodLibraryCollaborative FilteringKNN (User-Based, Cosine Similarity)SurpriseMatrix FactorizationSVD (Singular Value Decomposition)Surprise
What was done:
...
📊 Results Summary
TaskMethodMetricScoreTask 1Decision TreeAccuracy~95%+Task 2Logistic Regression + TF-IDFAccuracy~90%+Task 3CNN (3-block)Test Accuracy~70–75%Task 4SVDRMSELow error
...
Submitted as part of the CodTech Machine Learn
